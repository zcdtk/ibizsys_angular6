...
export enum IBizEvent {
     ...
     * IBizMDControl
     */
    IBizMDControl_SELECTIONCHANGE = 'IBizMDControl_SELECTIONCHANGE',
     ...
     * IBizMDControl
     */
    IBizMDControl_CHANGEEDITSTATE = 'IBizMDControl_CHANGEEDITSTATE',

    /**
     * 界面行为
     * IBizMDControl
     */
    IBizMDControl_UIACTION = 'IBizMDControl_UIACTION',
     ...
     * IBizDataGrid
     */
    IBizDataGrid_UPDATEGRIDITEMCHANGE = 'IBizDataGrid_UPDATEGRIDITEMCHANGE',
     ...
     * IBizFormItem
     */
    IBizFormItem_VALUECHANGED = 'IBizFormItem_VALUECHANGED',
